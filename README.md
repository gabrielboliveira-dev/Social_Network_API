...
-   **CI/CD:** GitHub Action
    -   *Justicativa:* Automação da esteira de desenvolvimento, executando a suíte de testes em uma máquina virtual isolada a cada novo push ou pull request, atuando como um guardião da qualidade do código.
